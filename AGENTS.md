...
- Route-specific convenience should stay typed. Prefer generated APIs like `AppRoutes.Provider` and `AppRoutes.Link` over existential router environment storage.
